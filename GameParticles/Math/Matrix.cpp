...
Matrix::Matrix(const Vect4D & inV0, const Vect4D & inV1, const Vect4D & inV2, const Vect4D & inV3)
{
	this->v0._m = inV0._m;
	this->v1._m = inV1._m;
	this->v2._m = inV2._m;
...
const float &Matrix::operator[](const INDEX_ENUM e)
{
...
//	Matrix m;
//	// this->v0 * mB
//	m.v0._m = _mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v0.x), rhs.v0._m),
//		_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v0.y), rhs.v1._m),
//			_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v0.z), rhs.v2._m), _mm_mul_ps(_mm_set_ps1(this->v0.w), rhs.v3._m))));
//	// this->v1 * mB
//	m.v1._m = _mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v1.x), rhs.v0._m),
//		_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v1.y), rhs.v1._m),
//			_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v1.z), rhs.v2._m), _mm_mul_ps(_mm_set_ps1(this->v1.w), rhs.v3._m))));
//	// this->v2 * mB
//	m.v2._m = _mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v2.x), rhs.v0._m),
//		_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v2.y), rhs.v1._m),
//			_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v2.z), rhs.v2._m), _mm_mul_ps(_mm_set_ps1(this->v2.w), rhs.v3._m))));
//	// this->v3 * mB
//	m.v3._m = _mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v3.x), rhs.v0._m),
//		_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v3.y), rhs.v1._m),
//			_mm_add_ps(_mm_mul_ps(_mm_set_ps1(this->v3.z), rhs.v2._m), _mm_mul_ps(_mm_set_ps1(this->v3.w), rhs.v3._m))));
//
//	return m;
//}
